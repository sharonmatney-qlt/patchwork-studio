...
import {
  SQUARE_PRESETS, GRID_PRESETS,
  hexToRgb, rgbToHex, shadeDark, shadeLight, contrastColor,
  scrappyNudge, lowVolumeNudge, ombreColor, rainbowColor,
  resolveSlots, resolveInverted, generatePattern,
  finishedSq, quiltFinishedDims, quiltSizeName, fmtIn,
...
// Color utilities, pattern generator, and dimension helpers are imported from @/lib/pattern-utils
